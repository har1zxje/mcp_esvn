...
} = require('../LibreChat/packages/client/src/theme/utils/createTailwindColors.js');
const libreChatTailwindPreset = require('../LibreChat/packages/client/tailwind.preset.cjs');
...
module.exports = {
  content: [
    ...
    '../LibreChat/packages/client/src/**/*.{js,jsx,ts,tsx}',
  ],
  // darkMode: 'class',
  darkMode: ['class'],
