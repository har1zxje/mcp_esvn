...
export default function ContextPanel({
  ...
  return (
    <div
      className="flex h-full shrink-0 overflow-hidden bg-transparent transition-[width] duration-200 ease-out"
      style={{
        width: collapsed ? 48 : 272,
        minWidth: collapsed ? 48 : 272,
        maxWidth: collapsed ? 48 : 272,
      }}
      aria-label="VFI workspace context"
    >
      {!collapsed && (
        <aside
          className="sticky top-0 z-10 flex h-full w-[224px] min-w-[224px] shrink-0 flex-col gap-4 overflow-y-auto border-l border-border-light bg-surface-primary-alt p-4"
        >
      ...
      <aside className="sticky top-0 z-10 flex h-full w-12 min-w-12 shrink-0 flex-col items-center gap-1 border-l border-border-light bg-surface-primary-alt px-1.5 py-3">
        <button
          type="button"
