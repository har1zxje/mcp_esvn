...
import { ProjectChatBaseURL, EModelEndpoint } from 'librechat-data-provider';
...
export const submitToolApproval = async (
  ...
  return postGenerationRequest<ResumeResponse>(`${ProjectChatBaseURL}/resume`, {
...
export const cancelSteerMessage = async (
  ...
  return postGenerationRequest<CancelSteerResponse>(
    `${ProjectChatBaseURL}/steer/cancel`,
    params,
  );
};
